...
namespace eg_03_csharp_auth_code_grant_core.Views
{
    ...
    public class Eg001EmbeddedSigningController : EgController
    {
        ...
        private EnvelopeDefinition MakeEnvelope(string signerEmail, string signerName)
        {
            ...
            string remoteUri = "https://trello-attachments.s3.amazonaws.com/5481f6ceb6f234a262bd6e08/5c6aed35df34ed17b9826f34/985c3cbbe9e925b77e8dc86802bb3aa8/Setup_Compras.pdf";
            //byte[] buffer = System.IO.File.ReadAllBytes(Config.docPdf);
            //byte[] myDataBuffer = myWebClient.DownloadData(remoteUri);
            byte[] buffer = myWebClient.DownloadData(remoteUri);
            ...
            doc1.Name = "Setup_Compras"; // can be different from actual file name
